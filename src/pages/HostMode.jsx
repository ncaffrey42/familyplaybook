            ...
            <div className="min-h-screen bg-background pb-24">
                <div className="p-6">
                    ...
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <div className="bg-card dark:bg-gray-800 rounded-3xl p-6 shadow-soft text-center">
                        ...
                        <div className="bg-card dark:bg-gray-800 rounded-3xl p-6 shadow-soft">
                        ...
                        {isHostModeActive && (
                            <motion.div
                                ...
                                className="bg-card dark:bg-gray-800 rounded-3xl p-6 shadow-soft text-center"
                            >
